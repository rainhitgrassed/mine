...
## Booting Pumpkin Library
```lua
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/rainhitgrassed/mine/main/pumpsource')))()
```
...
## Creating a Window
```lua
local Window = OrionLib:MakeWindow({Name = "PumpkinHack.cc", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest"})
